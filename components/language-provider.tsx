...
const translations: Translations = {
  ...
  // Hero
  "hero.title": {
    pt: "CASAMENTO CHIC PAGANDO POUCO",
    en: "ELEGANT WEDDING ON A BUDGET",
  },
  "hero.subtitle": {
...
export function useLanguage() {
  ...
  if (context === undefined) {
    ...
    // This can happen during server rendering or when components are rendered outside the provider
    return {
      ...
      t: (key: string) => {
        ...
        // Try to return the Portuguese translation if available
        if (translations[key]) {
